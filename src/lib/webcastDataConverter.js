...
function simplifyObject(webcastObject) {
	...
	if (webcastObject.battleUsers) {
		...
		webcastObject.battleUsers.forEach((user) => {
			...
			if (
				user !== null &&
				user !== void 0 &&
				(_user$battleGroup = user.battleGroup) !== null &&
				_user$battleGroup !== void 0 &&
				_user$battleGroup.user
			) {
	...
	if (webcastObject.giftId) {
		...
		webcastObject.gift = {
			...
			gift_type:
				(_webcastObject$giftDe = webcastObject.giftDetails) === null ||
				_webcastObject$giftDe === void 0
					? void 0
					: _webcastObject$giftDe.giftType,
		};
	...
	if (webcastObject.emote) {
		...
		webcastObject.emoteId =
			(_webcastObject$emote = webcastObject.emote) === null ||
			_webcastObject$emote === void 0
				? void 0
				: _webcastObject$emote.emoteId;
		webcastObject.emoteImageUrl =
			(_webcastObject$emote2 = webcastObject.emote) === null ||
			_webcastObject$emote2 === void 0
				? void 0
				: (_webcastObject$emote3 = _webcastObject$emote2.image) === null ||
						_webcastObject$emote3 === void 0
					? void 0
					: _webcastObject$emote3.imageUrl;
	...
	if (webcastObject.emotes) {
		webcastObject.emotes = webcastObject.emotes.map((x) => {
			...
			return {
				emoteId:
					(_x$emote = x.emote) === null || _x$emote === void 0
						? void 0
						: _x$emote.emoteId,
				emoteImageUrl:
					(_x$emote2 = x.emote) === null || _x$emote2 === void 0
						? void 0
						: (_x$emote2$image = _x$emote2.image) === null ||
								_x$emote2$image === void 0
							? void 0
							: _x$emote2$image.imageUrl,
	...
	if (webcastObject.treasureBoxUser) {
		var _webcastObject$treasu,
			_webcastObject$treasu2,
			_webcastObject$treasu3,
			_webcastObject$treasu4;

		// holy crap
		Object.assign(
			webcastObject,
			getUserAttributes(
				((_webcastObject$treasu = webcastObject.treasureBoxUser) === null ||
				_webcastObject$treasu === void 0
					? void 0
					: (_webcastObject$treasu2 = _webcastObject$treasu.user2) === null ||
							_webcastObject$treasu2 === void 0
						? void 0
						: (_webcastObject$treasu3 = _webcastObject$treasu2.user3[0]) ===
									null || _webcastObject$treasu3 === void 0
							? void 0
							: (_webcastObject$treasu4 = _webcastObject$treasu3.user4) ===
										null || _webcastObject$treasu4 === void 0
								? void 0
								: _webcastObject$treasu4.user) || {},
			),
		);
...
function getUserAttributes(webcastUser) {
	var _webcastUser$userId,
		_webcastUser$secUid,
		_webcastUser$profileP,
		_webcastUser$followIn,
		_webcastUser$badges,
		_webcastUser$createTi,
		_webcastUser$profileP2,
		_userAttributes$userB,
		_userAttributes$userB2,
		_userAttributes$userB3,
		_userAttributes$userB4,
		_userAttributes$userB5;

	let userAttributes = {
		userId:
			(_webcastUser$userId = webcastUser.userId) === null ||
			_webcastUser$userId === void 0
				? void 0
				: _webcastUser$userId.toString(),
		secUid:
			(_webcastUser$secUid = webcastUser.secUid) === null ||
			_webcastUser$secUid === void 0
				? void 0
				: _webcastUser$secUid.toString(),
		...
		profilePictureUrl: getPreferredPictureFormat(
			(_webcastUser$profileP = webcastUser.profilePicture) === null ||
				_webcastUser$profileP === void 0
				? void 0
				: _webcastUser$profileP.urls,
		),
		followRole:
			(_webcastUser$followIn = webcastUser.followInfo) === null ||
			_webcastUser$followIn === void 0
				? void 0
				: _webcastUser$followIn.followStatus,
		userBadges: mapBadges(webcastUser.badges),
		userSceneTypes:
			(_webcastUser$badges = webcastUser.badges) === null ||
			_webcastUser$badges === void 0
				? void 0
				: _webcastUser$badges.map(
						(x) =>
							(x === null || x === void 0 ? void 0 : x.badgeSceneType) || 0,
					),
		userDetails: {
			createTime:
				(_webcastUser$createTi = webcastUser.createTime) === null ||
				_webcastUser$createTi === void 0
					? void 0
					: _webcastUser$createTi.toString(),
			bioDescription: webcastUser.bioDescription,
			profilePictureUrls:
				(_webcastUser$profileP2 = webcastUser.profilePicture) === null ||
				_webcastUser$profileP2 === void 0
					? void 0
					: _webcastUser$profileP2.urls,
		},
	};
	...
	userAttributes.topGifterRank =
		(_userAttributes$userB =
			(_userAttributes$userB2 = userAttributes.userBadges.find(
				(x) => x.url && x.url.includes("/ranklist_top_gifter_"),
			)) === null || _userAttributes$userB2 === void 0
				? void 0
				: (_userAttributes$userB3 = _userAttributes$userB2.url.match(
							/(?<=ranklist_top_gifter_)(\d+)(?=.png)/g,
						)) === null || _userAttributes$userB3 === void 0
					? void 0
					: _userAttributes$userB3.map(Number)[0]) !== null &&
		_userAttributes$userB !== void 0
			? _userAttributes$userB
			: null;
	userAttributes.gifterLevel =
		((_userAttributes$userB4 = userAttributes.userBadges.find(
			(x) => x.badgeSceneType === 8,
		)) === null || _userAttributes$userB4 === void 0
			? void 0
			: _userAttributes$userB4.level) || 0; // BadgeSceneType_UserGrade

	userAttributes.teamMemberLevel =
		((_userAttributes$userB5 = userAttributes.userBadges.find(
			(x) => x.badgeSceneType === 10,
		)) === null || _userAttributes$userB5 === void 0
			? void 0
			: _userAttributes$userB5.level) || 0; // BadgeSceneType_Fans
...
function mapBadges(badges) {
	...
	if (Array.isArray(badges)) {
		badges.forEach((innerBadges) => {
			...
			if (
				(_innerBadges$privileg = innerBadges.privilegeLogExtra) !== null &&
				_innerBadges$privileg !== void 0 &&
				_innerBadges$privileg.level &&
				((_innerBadges$privileg2 = innerBadges.privilegeLogExtra) === null ||
				_innerBadges$privileg2 === void 0
					? void 0
					: _innerBadges$privileg2.level) !== "0"
			) {
				simplifiedBadges.push({
					type: "privilege",
