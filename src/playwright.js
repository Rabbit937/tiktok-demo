...
async function connectLive(link) {
	...
	const browser = await chromium.launchPersistentContext(
		setting.playwright.chromeUserDataUrl,
		{
						...
						.forEach((message) => {
							...
							switch (message.type) {
								...
								case "WebcastQuestionNewMessage":
									webSocket.send(
										JSON.stringify({
											type: MessageEvents.QUESTIONNEW,
											data: simplifiedObj,
										}),
									);
									break;
								case "WebcastLinkMicBattle":
									webSocket.send(
										JSON.stringify({
											type: MessageEvents.LINKMICBATTLE,
											data: simplifiedObj,
										}),
									);
								...
								case "WebcastLinkMicArmies":
									webSocket.send(
										JSON.stringify({
											type: MessageEvents.LINKMICARMIES,
											data: simplifiedObj,
										}),
									);
